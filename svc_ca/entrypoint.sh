...
export CFSSL_HOSTS="sys_ca, sysca.sez23.net, 127.0.0.1, localhost"
gen-cert "ca" "se23-sys-ca" -tls-remote-ca="sub-ca.pem" -loglevel=0
...
export CFSSL_DB_CONFIG="db-config.json"
export CFSSL_PROFILE="server"
gen-cert "tls" "se23-sys-ca-tls" 

export CFSSL_PROFILE="signer"
gen-cert "etcd-server" "se23-etcd-server-ca" 
gen-cert "etcd-peer" "se23-etcd-peer-ca" 
gen-cert "etcd-client" "se23-etcd-client-ca" 
gen-cert "docker" "se23-docker-ca" 
